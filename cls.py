...
IMAGE_FILENAMES = ['images/go_test.jpg', 'images/dog_and_human.jpg', 'images/pizza.jpg', 'images/burger.jpg', 'images/cat.jpg']
...
print('top_categort =',top_category)

result = classification_result.classifications[0].categories
print('result =', result)
